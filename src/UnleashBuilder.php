...
final class UnleashBuilder
{
    ...
    /**
     * @var \Unleash\Client\Repository\UnleashRepository|null
     */
    private $repository;
    ...
    public function build(): Unleash
    {
        ...
        $dependencyContainer = $this->createContainer(
            ...
            $dependencyContainer->getStaleCache(),
            $dependencyContainer->getHttpClient(),
            $dependencyContainer->getRequestFactory(),
            $dependencyContainer->getContextProvider(),
            $dependencyContainer->getBootstrapHandler(),
            $dependencyContainer->getBootstrapProvider(),
            $dependencyContainer->getEventDispatcher(),
            $dependencyContainer->getMetricsBucketSerializer(),
            $dependencyContainer->getMetricsCache(),
            $metricsSender,
