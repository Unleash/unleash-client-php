...
final class DefaultProxyFeatureTest extends TestCase
{
    ...
    public function testToJson()
    {
        ...
        self::assertEquals('{"name":"test","enabled":true,"variant":{"name":"someVariant","enabled":true,"feature_enabled":false,"payload":{"type":"string","value":"test"}},"impression_data":true}', $json);
    }
}
